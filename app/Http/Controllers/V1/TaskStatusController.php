...
class TaskStatusController extends Controller
{
    ...
    {
        $data = resolve(TaskStatusService::class)->handle();

        return ResponseApi::responseSuccess(TaskStatusResource::collection($data));
    }
    ...
    {
        $data = $this->taskStatusRepository->find($id);
